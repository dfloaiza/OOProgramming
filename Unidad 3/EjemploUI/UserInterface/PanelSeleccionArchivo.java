...
public class PanelSeleccionArchivo extends JPanel implements ActionListener {
	...
	public PanelSeleccionArchivo(VentanaPrincipal ventanaMadre)
	{
		miVentanaPrincipal = ventanaMadre;
	...
	public void cargarInformacion(String rutaArchivo)
	{
		...
		try 
		{
			...
			miVentanaPrincipal.actualizarPanelListaUsuarios(listaUsuarios);
